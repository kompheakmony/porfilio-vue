...
<template>
    <div class="w-full flex justify-center">
      ...
      <nav
        class="fixed z-[999] left-1/2 -translate-x-1/2 flex items-center gap-5 bg-yellow-800/60 px-6 py-3 backdrop-blur-md rounded-full text-gray-200 duration-300"
